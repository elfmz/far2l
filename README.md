...
| ---: | --- | --- | --- | --- |
| Works: | in terminal | in terminal | in terminal | in Desktop<br>environment<br>(X11<br>or Wayland<br>or macOS) |
| Binaries: | far2l | far2l<br>far2l_ttyx.broker | far2l<br>far2l_ttyx.broker | far2l<br>far2l_gui.so |
| Dependencies: | minimal | + libx11 | + libx11,<br>libxi | wxWidgets,<br>GTK |
