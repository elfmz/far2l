	...
	static DWORD EvaluateAttributesT(uint32_t unix_mode, const CHAR_T *name)
{
	...
	switch (unix_mode & S_IFMT) {
		...
		case S_IFSOCK: rv = FILE_ATTRIBUTE_DEVICE | FILE_ATTRIBUTE_DEVICE_SOCK; break;
#endif
		case S_IFCHR: rv = FILE_ATTRIBUTE_DEVICE | FILE_ATTRIBUTE_DEVICE_CHAR; break;
		case S_IFBLK: rv = FILE_ATTRIBUTE_DEVICE | FILE_ATTRIBUTE_DEVICE_BLOCK; break;
		case S_IFIFO: rv = FILE_ATTRIBUTE_DEVICE | FILE_ATTRIBUTE_DEVICE_FIFO; break;
