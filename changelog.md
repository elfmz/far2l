...
* _ImageViewer plugin_: New actions: **I** / **F3** - show full EXIF metadata using `exiftool`; **G** / **Alt+F8** - choose a map service and open the GPS location from the current file's EXIF metadata in a browser; **T** / **Ctrl+F10** - exit and move the panel cursor to the currently viewed file.
