...
SourceSwitch           :=-c 
OutputFile             :=../Build/Plugin/Colorer/bin/$(ProjectName).so
...
CXX      := /usr/bin/g++
CC       := /usr/bin/gcc
CXXFLAGS :=  -g -O1 -O -O2 -std=c++11 -std=c99 $(shell wx-config --cxxflags --debug=yes --unicode=yes) -fPIC $(Preprocessors)
CFLAGS   :=  -g -O1 -O -O2 -std=c++11 -std=c99 $(shell wx-config --cxxflags --debug=yes --unicode=yes) -fPIC $(Preprocessors)
ASFLAGS  := 
AS       := /usr/bin/as
