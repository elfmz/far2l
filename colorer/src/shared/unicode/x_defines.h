...
#define CHAR_PROP(c) (arr_CharInfo[ (arr_idxCharInfo[(c & 0xFFFF)>>4]<<4) + ((c) & (0xFFFF>>(16-4)))])
#define CHAR_PROP2(c) (arr_CharInfo2[ (arr_idxCharInfo2[(c & 0xFFFF)>>4]<<4) + ((c) & (0xFFFF>>(16-4)))])
