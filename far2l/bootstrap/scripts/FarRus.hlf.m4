...
кодовую страницу, применяемую для поиска текста.
...
любой "внутренней" строки
    #x# - ^<wrap>просто пробельные знаки (без слеша впереди) игнорируются -
...
знаком "насильственно". Для этого надо перед ним поставить слеш -
#\#.
