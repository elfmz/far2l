...
$ #Особенности FAR2L - начало работы#
 ...
 #Режимы интерфейса#
    У FAR2L три основных бекенда отрисовки (подробности в ~Режимы интерфейса~@UIBackends@):
        ...
        - TTY - чистый терминальный режим, никаких иксовых зависимостей, UX с некоторыми ограничениями (полноценно работает при запуске в соответствующих эмуляторах терминалов, используя их расширенные возможности передачи клавиш, см. ниже).
 ...
 #Особенности Wayland#
    Для адекватной работы в Wayland помогает запустить в режиме xWayland, указав переменную среды #GDK_BACKEND=x11#, т.к. FAR2L (режимы GUI и TTYXi) для работы с буфером обмена и получения расширенных сочетаний клавиш использует возможности X11, которые в таком виде ограничены или недоступны или несовместимы в чистом Wayland'е:
...
~Настройки редактора~@EditorSettings@.
  ...
  Операции над блоками
   ...
   #Alt-U#                   Сдвинуть блок влево на 1 пробел
   #Alt-I#                   Сдвинуть блок вправо на 1 пробел
   #Shift-Tab#               Сдвинуть блок влево на Tab (или на indent size, если включено преобразование табуляции)
   #Tab#                     Сдвинуть блок вправо на Tab (или на indent size, если включено преобразование табуляции)
