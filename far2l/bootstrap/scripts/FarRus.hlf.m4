...
предоставляющих возможность доступа к буферу обмена и расширенную информацию о клавиатурных событиях, см. список ниже).
 ...
 #Перехват комбинаций клавиш оболочками и терминалами#
    ...
    Также можно использовать лайфхаки FAR2L:
        ...
        - опцию Эксклюзивная обработка нажатий в ~параметрах ввода~@InputSettings@ (только в GUI режиме).
...
вывод команд, используя возможности встроенного просмотрщика и редактора, такие как скроллинг, поиск подстрок и т.п. Вы так же можете открыть
...
или же его первоначальная копия будут перезаписаны.
    ...
    Выпадающий список #Символические ссылки# позволяет выбрать один из трех возможных 
