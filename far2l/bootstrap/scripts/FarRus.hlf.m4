...
управления курсором доступны следующие клавиши:
  ...
  Переключение в режим быстрой фильтрации                  #Ctrl-Alt-F#
  (показывать только пункты, содержащие вводимый текст)

  Горизотальная прокрутка длинных строк            #Alt-Left,Alt-Right#
                                                     #Alt-Home,Alt-End#
...
Реестре главного меню.
    ...
    Нажмите #Ctrl-Alt-F# для переключения в режим быстрой фильтрации (показывает только элементы, содержащие вводимый текст).
...
#Ctrl-H#.
    ...
    Используте #Ctrl-Alt-F# для переключения в режим быстрой фильтрации
(показывает только элементы, содержащие вводимый текст).
...
только для дисков).
    ...
    #Ctrl-Alt-F# для переключения в режим быстрой фильтрации
(показывает только элементы, содержащие вводимый текст).
...
реализовать дополнительную логику динамического построения списка переходов.
   ...
   См. так же список ~макроклавиш~@KeyMacroDisksList@, доступных в меню перехода.
