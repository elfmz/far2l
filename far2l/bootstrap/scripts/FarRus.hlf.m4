...
$ #Список задач#
    ...
    #Ctrl-Alt-F#         Фильтровать элементы списка (автообновление приостановливается во время фильтрации)
    #Enter#              Переход к каталогу #/proc/PID# на активной панели (только в Linux)
