...
@Terminal
$ #Терминал
    FAR2L содержит встроенный эмулятор псевдотерминала, позволяющий исполнять приложения командной строки и управлять ими, наблюдая их вывод.
    Для союлюдения привычного пользовательског опыта far2l запускает приложения внутри поддериваемой интерактивной оболочки командной строки.
    ...
    #Кнопкосочетания и скроллинг во время исполнения команды:# вы можете использовать кнопкосочетание Ctrl+Shift+F3 чтобы открыть испторию
    вывода терминала во встроенном просмотрщике или Ctrl+Shift+F4 - чтобы открыть ее во встроенном редакторе. Это ползволяет эффективно исследовать
