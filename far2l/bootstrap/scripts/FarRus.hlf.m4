...
центральном разделителе для каждого блока изменений показаны стрелки слияния.
...
стрелку, затем нажмите #Enter# или #F5#. Щелчок мыши по стрелке сразу выполняет
слияние. Каждое слияние записывается как одна операция отмены в целевой панели.
