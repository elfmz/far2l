...
far2l. В этом случае far2l автоматически использует режим TTY с расширениями терминала far2l.
Этот ключ выключает данную функциональность, предотвращая автоопределение наличие far2l-расширений
в текущем терминале.
...
функциональность требует ядро Linux версии 4.5 или выше и файловую систему, которая
поддерживает такие файлы. В противном случае файлы будут скопированы обычным способом.
