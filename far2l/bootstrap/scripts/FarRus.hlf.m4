...
и может быть переключена через #Ctrl-Alt-N#.

  #Панели: Показывать маркировку имен файлов# и #Выравнивать имена файлов по маркировкам#
...
также может быть открыть из панели по #Ctrl-Alt-D#.
