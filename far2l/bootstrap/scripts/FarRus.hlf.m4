...
от стиля конца строки, принятого в файле. Их поведение идентично: в строке замены
они не обозначают буквальные символы LF и CR. Поэтому поиск #\r\n# с заменой на
#\n# не преобразует окончания строк CRLF в LF.
