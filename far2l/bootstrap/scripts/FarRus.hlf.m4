...
удобства использования аналогичный режиму GUI.
...
в SSH сессии с включенным форвардингом протокола X11 и сжатием (ssh -X -C ...) что позволяет использовать режим TTY|Xi
или хотябы TTY|X. При этом #крайне не рекомендуется использовать форвардинг X11 при подключении к не доверенному серверу#,
