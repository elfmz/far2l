...
$ #Особенности FAR2L - начало работы#
 ...
 #Режимы интерфейса#
    У FAR2L три основных бекенда отрисовки (подробности в ~Режимы интерфейса~@UIBackends@):
        ...
        - #TTY|Xi# - работает в терминальном режиме, зависимости буквально от пары иксовых либ (для поддержки всех-всех сочетаний клавиш и буфера обмена), почти идеальный UX;
 ...
 #Особенности под Wayland или под WSL+WSLg (при проблемах с буфером обмена и/или комбинациями клавиш в FAR2L-GUI/TTY|X)#
    FAR2L (режимы GUI и TTY|X) для работы с буфером обмена и получения расширенных сочетаний клавиш использует возможности X11, которые из соображений безопасности ограничены в чистом Wayland'е.
