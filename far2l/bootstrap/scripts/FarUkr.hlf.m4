...
залежно від стилю кінця рядка, прийнятого у файлі. Їхня поведінка ідентична: у
рядку заміни вони не позначають буквальні символи LF і CR. Тому пошук #\r\n# із
заміною на #\n# не перетворює закінчення рядків CRLF на LF.
