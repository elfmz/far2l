...
центральному роздільнику для кожного блоку змін показано стрілки об'єднання.
...
файлу. Якщо активний роздільник, клавішами #Left# і #Right# виберіть стрілку,
потім натисніть #Enter# або #F5#. Клацання стрілки одразу виконує об'єднання.
Кожне об'єднання записується як одна операція скасування в цільовій панелі.
