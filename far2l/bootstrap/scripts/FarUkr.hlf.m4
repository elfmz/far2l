...
#Del# ^<wrap>Видалити символ (також може видалити блок, залежно від ~Налаштувань редактора~@EditorSettings@)
 ...
 #Ctrl-Shift-F5#           Перемкнути відображення фізичних закінчень рядків
...
поточну позицію без змін.
 ...
 Коли показ закінчень рядків увімкнено клавішами #Ctrl-Shift-F5#, фізичні
закінчення рядків відображаються як #␍# (CR) і #␊# (LF), що дає змогу побачити
змішані закінчення рядків.
...
кількість пробілів.
 ...
 якому стоїть курсор.
  ...
  #Закінчення рядків#       Показувати фізичні закінчення рядків як #␍# (CR)
                          і #␊# (LF). Опція перемикається натисканням
                          #Ctrl-Shift-F5# у редакторі.
...
#\r# і #\n# позначають буквальні символи CR і LF. Захоплені закінчення рядків
також зберігаються точно, тому #\r\n# можна замінити на #\n#, а кожен символ
пари CRLF можна шукати й замінювати окремо.
