...
DirSettingsHint1
"Для подстройки ширины столбца под текст"
"To adjust column width to text"
upd:"To adjust column width to text"
upd:"To adjust column width to text"
upd:"To adjust column width to text"
upd:"To adjust column width to text"
upd:"To adjust column width to text"
...
DirSettingsHint2
" установите в режимах панели её ширину в 0"
" set in file panel mode it width to 0"
upd:" set in file panel mode it width to 0"
upd:" set in file panel mode it width to 0"
upd:" set in file panel mode it width to 0"
upd:" set in file panel mode it width to 0"
upd:" set in file panel mode it width to 0"
