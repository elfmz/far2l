...
uint8_t DefaultColorsIndex16[SIZE_ARRAY_FARCOLORS] = {
		...
		F_LIGHTGRAY | B_BLACK,          // COL_DIALOGLISTSELPREFIX,
		F_DARKGRAY | B_CYAN,            // COL_DIALOGCOMBOPREFIX,
		F_DARKGRAY | B_RED,             // COL_DIALOGCOMBOSELPREFIX,
		F_BLACK | B_LIGHTGRAY,          // COL_WARNDIALOGLISTPREFIX,
		F_DARKGRAY | B_RED,             // COL_WARNDIALOGLISTSELPREFIX,
		F_DARKGRAY | B_CYAN,            // COL_WARNDIALOGCOMBOPREFIX,
		F_LIGHTGRAY | B_BLACK,          // COL_WARNDIALOGCOMBOSELPREFIX,
		F_DARKGRAY | B_CYAN,            // COL_MENUPREFIX,
