...
#include <stdlib.h>
  ...
  static inline wchar_t __cdecl Upper(wchar_t Ch) { WINPORT(CharUpperBuff)(&Ch, 1); return Ch; }
...
extern "C" {
  ...
  extern int DialogFromTemplate(const TCHAR* sTitle,
         const DialogTemplateItem* aTplItems,
         struct FarDialogItem* aDialogItems,
         int nItemsNumber, TCHAR* sHelpTopic,
