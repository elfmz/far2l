...
HANDLE  RAROpenArchive(struct RAROpenArchiveData *ArchiveData);
...
int     RARProcessFileW(HANDLE hArcData,int Operation,wchar_t *DestPath,wchar_t *DestName);
void    RARSetCallback(HANDLE hArcData,UNRARCALLBACK Callback,LPARAM UserData);
void    RARSetChangeVolProc(HANDLE hArcData,CHANGEVOLPROC ChangeVolProc);
void    RARSetProcessDataProc(HANDLE hArcData,PROCESSDATAPROC ProcessDataProc);
