...
TypeFKey(9)
ExpectString("Left    Files    Commands    Options    Right", 0, 0, 0, 0, 10000);
TypeText("on")
ExpectString("══ Confirmations ══", 0, 0, 0, 0, 10000);
ToggleLAlt(true)
TypeText("x")
ToggleLAlt(false)
TypeEnter()
ExpectNoString("══ Confirmations ══", 0, 0, 0, 0, 10000);

// Shift+F9 to save settings
ToggleShift(true)
TypeFKey(9)
ToggleShift(false)
ExpectString("══ Save setup ══", 0, 0, 0, 0, 10000);
TypeEnter()
ExpectNoString("══ Save setup ══", 0, 0, 0, 0, 10000);
