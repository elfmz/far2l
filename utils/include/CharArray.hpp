	...
	size_t CharArrayLen(const ARRAY_T &a)
{
	...
	static_assert ( std::is_array_v<ARRAY_T>, "CharArrayLen should be used with arrays but not pointers");
...
{
	static_assert ( std::is_pod<ARRAY_T>::value, "CharArrayLen should be used with POD array types only");
	static_assert ( std::is_array_v<ARRAY_T>, "CharArrayChr should be used with arrays but not pointers");
	...
	CHAR_T *CharArrayRChr(ARRAY_T &a, CHAR_T c)
{
	...
	static_assert ( std::is_array_v<ARRAY_T>, "CharArrayRChr should be used with arrays but not pointers");
	...
	int CharArrayCmp(const ARRAY1_T &a1, const ARRAY2_T &a2)
{
	...
	static_assert ( std::is_array_v<ARRAY1_T> && std::is_array_v<ARRAY2_T>, "CharArrayCmp should be used with arrays but not pointers");
	size_t i;
	...
	void CharArrayAssignToStr(STRING_T &s, const ARRAY_T &a)
{
	...
	static_assert ( std::is_array_v<ARRAY_T>, "CharArrayAssignToStr should be used with arrays but not pointers");
	...
	void CharArrayAppendToStr(STRING_T &s, const ARRAY_T &a)
{
	...
	static_assert ( std::is_array_v<ARRAY_T>, "CharArrayAppendToStr should be used with arrays but not pointers");
	...
	bool CharArrayMatchStr(const ARRAY_T &a, STRING_T &s)
{
	...
	static_assert ( std::is_array_v<ARRAY_T>, "CharArrayMatchStr should be used with arrays but not pointers");
	...
	void CharArrayCpyZ(ARRAY_T &dst, const CHAR_T *src)
{
	...
	static_assert ( std::is_array_v<ARRAY_T>, "CharArrayCpyZ should be used with arrays but not pointers");
	size_t i;
	...
	void CharArrayCpy(ARRAY_T &dst, const CHAR_T *src)
{
	...
	static_assert ( std::is_array_v<ARRAY_T>, "CharArrayCpy should be used with arrays but not pointers");
	size_t i;
