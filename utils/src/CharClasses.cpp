...
bool IsCharPrefix(wchar_t c)
{
	switch (c) {
		...
		case 0x6cd:
		case 0x6cf:
		case 0x6d2: case 0x6d3:
		case 0x6d5:
		case 0x6ee: case 0x6ef:
		case 0x710:
		case 0x715 ... 0x719:
		case 0x71e:
		case 0x728:
		...
		case 0x74d:
		case 0x759 ... 0x75b:
		case 0x76b: case 0x76c:
		case 0x771:
		case 0x773: case 0x774:
		case 0x778: case 0x779:
		case 0x840:
		case 0x846: case 0x847:
		case 0x849:
		case 0x854:
		case 0x856 ... 0x858:
		case 0x867:
		case 0x869: case 0x86a:
		case 0x870 ... 0x882:
		case 0x88e:
		case 0x8aa ... 0x8ac:
		case 0x8ae:
		case 0x8b1: case 0x8b2:
		case 0x8b9:
		case 0xd800 ... 0xdfff:
		case 0x10ac5:
		case 0x10ac7:
		case 0x10ac9: case 0x10aca:
		case 0x10ace ... 0x10ad2:
		case 0x10add:
		case 0x10ae1:
		case 0x10ae4:
		case 0x10aef:
		case 0x10b81:
		case 0x10b83 ... 0x10b85:
		case 0x10b89:
		case 0x10b8c:
		case 0x10b8e: case 0x10b8f:
		case 0x10b91:
		case 0x10ba9 ... 0x10bac:
		case 0x10d22:
		case 0x10f33:
		case 0x10f54:
		case 0x10f74: case 0x10f75:
		case 0x10fb4 ... 0x10fb6:
		case 0x10fb9: case 0x10fba:
		case 0x10fbd:
